    ...
    const handleSubmit = (e) => {
        ...
        if(actualData.password && actualData.password_confirmation) {
            if (actualData.password && actualData.password_confirmation) {
                ...
                setError({status:true, msg: "Congrats, Password reset successful. Please login...!", type: 'success'})
                //navigate('/')
                setTimeout ( () => {
                    navigate("/loginreg")
                }, 3000)
            ...
            setError({status:true, msg: "Fields must not empty!", type: 'error'})
        }
    }
            ...
            <Grid item sm={6} xs={12}>
                <Box component='form' noValidate sx={{mt: 1}} id='password-reset-form' onSubmit={handleSubmit}>
                    ...
                    <Box textAlign='center'>
                        <Button type='submit' variant='contained' sx={{mt:3, mb:2, px:5}}>Create</Button>
                    </Box>
