    ...
    const handleSubmit = (e) => {
        ...
        if (actualData.name && actualData.email && actualData.password && actualData.password_confirmation && actualData.tc !== null) {
            if (actualData.password === actualData.password_confirmation) {
                ...
                setError({ status: true, msg: "You have successfully registered!", type: 'success' })
                navigate('/dashboard')
            } 
            else {
  ...
  return (
    <>
        <Box component='form' noValidate sx={{ mt: 1 }} id='registration-form' onSubmit={handleSubmit}>
            ...
            <FormControlLabel control={<Checkbox value="agree" color="primary" name="tc" id="tc" />} label="I accept the term and condition." />
